...
class SchemaWidget extends Component {
   ...
   */
  onDeleteFieldset() {
    if (this.state.currentFieldset > this.props.value.fieldsets.length - 1) {
      this.setState({
  ...
  render() {
    ...
    return (
      <div>
          ...
          >
            {map(value.fieldsets, (item, index) => (
              <SchemaWidgetFieldset
                ...
                onShowEditFieldset={
                  this.props.editFieldset ? this.onShowEditFieldset : null
                }
                onShowDeleteFieldset={
                  this.props.deleteFieldset ? this.onShowDeleteFieldset : null
                }
                onOrderFieldset={this.onOrderFieldset}
              />
            ))}
            {this.props.editFieldset && (
              <div className="item">
                <button
        ...
        {(this.state.addField !== null || this.state.editField !== null) && (
          <ModalForm
            onSubmit={this.state.addField ? this.onAddField : this.onEditField}
            onCancel={this.onCancel}
            title={
              this.state.addField
                ? this.props.intl.formatMessage(messages.addField)
                : this.props.intl.formatMessage(messages.editField)
            }
            formData={
              this.state.addField
